...
const PACKAGES = [
  {
    ...
    tagline:    "Understand what you're likely dealing with — before you call anyone.",
    ...
    features: [
      ...
      'Which type of contractor to hire and what credentials to verify',
  ...
  },
  {
    ...
    label:      'Quote Shield',
    tagline:    "See how the price compares to typical costs — and get the language to push back.",
